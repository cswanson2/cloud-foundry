...
## Deprecation of IBM Cloud Foundry Enterprise
{: #deprecation}
...
* [Documentation & Getting Started on OpenShift on IBM Cloud](https://cloud.ibm.com/docs/openshift?topic=openshift-openshift_tutorial)
* [Guided Tour to Red Hat OpenShift on IBM Cloud](https://developer.ibm.com/technologies/containers/videos/red-hat-openshift-on-ibm-cloud-video/)
